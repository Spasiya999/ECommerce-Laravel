            ...
            <div class="full-width-mega-dropdown">
                <div class="row">
                    ...
                    <div class="col-lg-2 col-md-4">
                        <div class="logo">
                            <a href="/">
                                <img src="{{ asset('store-assets/img/logo/logo.png') }}" alt="main logo">
                            </a>
                        </div>
                    </div>
                    <!-- primary-menu -->
                                ...
                                <li class="mega-parent"><a href="#">Category</a>
                                    <div class="mega-menu-area clearfix">
                                        ...
                                        <div class="mega-menu-photo f-left">
                                            <a href="#">
                                                <img src="{{ asset('store-assets/img/mega-menu/1.jpg') }}" alt="mega menu image">
                                            </a>
                                        </div>
                                    </div>
                                </li>
                                            ...
                                            <div class="total-cart-pro">
                                                ...
                                                <div class="single-cart clearfix">
                                                    <div class="cart-img f-left">
                                                        <a href="#">
                                                            <img src="{{ asset('store-assets/img/cart/1.jpg') }}" alt="Cart Product" />
                                                        </a>
                                                        <div class="del-icon">
                                                            <a href="#">
