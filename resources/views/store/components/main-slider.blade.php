<div class="slider-area slider-2 section">
    <div class="bend niceties preview-2">
        <div id="nivoslider-2" class="slides">   
            <img src="{{ asset('store-assets/img/slider/slider-2/slider-1.jpg') }}" alt="" title="#slider-direction-1"  />
            <img src="{{ asset('store-assets/img/slider/slider-2/slider-1.jpg') }}" alt="" title="#slider-direction-2"  />
            <img src="{{ asset('store-assets/img/slider/slider-2/slider-1.jpg') }}" alt="" title="#slider-direction-3"  />
            <img src="{{ asset('store-assets/img/slider/slider-2/slider-1.jpg') }}" alt="" title="#slider-direction-4"  />
            <img src="{{ asset('store-assets/img/slider/slider-2/slider-1.jpg') }}" alt="" title="#slider-direction-5"  />
        </div>
        <!-- ===== direction 1 ===== -->
        <div id="slider-direction-1" class="slider-direction">
            ...
            <div class="slider-content-1-image">
                <div class="wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.5s">
                    <div class="layer-1-1">
                        <img src="{{ asset('store-assets/img/slider/slider-2/layer-1.png') }}" alt="" />
                    </div>
                </div>
            </div>
        </div>
        ...
        <div id="slider-direction-2" class="slider-direction">
            ...
            <div class="wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.5s">
                <div class="layer-1-1 layer-2-1">
                    <img src="{{ asset('store-assets/img/slider/slider-2/layer-2.png') }}" alt="" />
                </div>
            </div>
        </div>
        <!-- ===== direction 3 ===== -->
