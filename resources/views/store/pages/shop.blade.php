...
<div id="page-content" class="page-wrapper section" style="margin-top:150px;">
                                ...
                                <div class="row">
                                        ...
                                        <div class="product-item">
                                            <div class="product-img">
                                                <a href="single-product">
                                                    <img src="{{ asset('store-assets/img/product/7.jpg') }}" alt=""/>
                                                </a>
                                            </div>
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="product-item">
                                            <div class="product-img">
                                                <a href="single-product">
                                                    <img src="{{ asset('store-assets/img/product/2.jpg') }}" alt=""/>
                                                </a>
                                            </div>
                                            <div class="product-info">
                                                <h6 class="product-title">
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="product-item">
                                            <div class="product-img">
                                                <a href="single-product">
                                                    <img src="{{ asset('store-assets/img/product/9.jpg') }}" alt=""/>
                                                </a>
                                            </div>
                                            <div class="product-info">
                                                <h6 class="product-title">
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="product-item">
                                            <div class="product-img">
                                                <a href="single-product">
                                                    <img src="{{ asset('store-assets/img/product/10.jpg') }}" alt=""/>
                                                </a>
                                            </div>
                                            <div class="product-info">
                                                <h6 class="product-title">
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="product-item">
                                            <div class="product-img">
                                                <a href="single-product">
                                                    <img src="{{ asset('store-assets/img/product/11.jpg') }}" alt=""/>
                                                </a>
                                            </div>
                                            <div class="product-info">
                                                <h6 class="product-title">
                                            ...
                                            <div class="product-info">
                                                <div class="clearfix">
                                                    <h6 class="product-title f-left">
                                                        <a href="single-product">Dummy Product Name </a>
                                                    </h6>
