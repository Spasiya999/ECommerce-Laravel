...
<section id="page-content" class="page-wrapper section">
    ...
    <div class="breadcrumbs-section plr-200 mb-80 section" style="margin-top:140px;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-5">
                                <div class="imgs-zoom-area">
                                    <img id="zoom_03" src="{{ asset('store-assets/img/product/6.jpg') }}" data-zoom-image="{{ asset('store-assets/img/product/6.jpg') }}" alt="">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div id="gallery_01" class="carousel-btn slick-arrow-3 mt-30">
                                                <div class="p-c">
                                                    <a href="#" data-image="{{ asset('store-assets/img/product/2.jpg') }}" data-zoom-image="{{ asset('store-assets/img/product/2.jpg') }}">
                                                        <img class="zoom_03" src="{{ asset('store-assets/img/product/2.jpg') }}" alt="">
                                                    </a>
                                                </div>
                                                <div class="p-c">
                                                    <a href="#" data-image="{{ asset('store-assets/img/product/3.jpg') }}" data-zoom-image="{{ asset('store-assets/img/product/3.jpg') }}">
                                                        <img class="zoom_03" src="{{ asset('store-assets/img/product/3.jpg') }}" alt="">
                                                    </a>
                                                </div>
                                                <div class="p-c">
                                                    <a href="#" data-image="{{ asset('store-assets/img/product/4.jpg') }}" data-zoom-image="{{ asset('store-assets/img/product/4.jpg') }}">
                                                        <img class="zoom_03" src="{{ asset('store-assets/img/product/4.jpg') }}" alt="">
                                                    </a>
                                                </div>
                                                <div class="p-c">
                                                    <a href="#" data-image="{{ asset('store-assets/img/product/5.jpg') }}" data-zoom-image="{{ asset('store-assets/img/product/5.jpg') }}">
                                                        <img class="zoom_03" src="{{ asset('store-assets/img/product/5.jpg') }}" alt="">
                                                    </a>
                                                </div>
                                                <div class="p-c">
                                                    <a href="#" data-image="{{ asset('store-assets/img/product/6.jpg') }}" data-zoom-image="{{ asset('store-assets/img/product/6.jpg') }}">
                                                        <img class="zoom_03" src="{{ asset('store-assets/img/product/6.jpg') }}" alt="">
                                                    </a>
                                                </div>
                                                <div class="p-c">
                                                    <a href="#" data-image="{{ asset('store-assets/img/product/7.jpg') }}" data-zoom-image="{{ asset('store-assets/img/product/7.jpg') }}">
                                                        <img class="zoom_03" src="{{ asset('store-assets/img/product/7.jpg') }}" alt="">
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="reviews-tab-desc">
                                                ...
                                                <div class="media mt-30">
                                                    <div class="media-left">
                                                        <a href="#"><img class="media-object" src="{{ asset('store-assets/img/author/1.jpg') }}" alt="#"></a>
                                                    </div>
                                                ...
                                                <div class="media mt-30">
                                                    <div class="media-left">
                                                        <a href="#"><img class="media-object" src="{{ asset('store-assets/img/author/2.jpg') }}" alt="#"></a>
                                                    </div>
                                                    <div class="media-body">
                                                        <div class="clearfix">
                                                            <div class="name-commenter pull-left">
                                    ...
                                    <div class="product-item">
                                        <div class="product-img">
                                            <a href="single-product.html">
                                                <img src="{{ asset('store-assets/img/product/1.jpg') }}" alt="" />
                                            </a>
                                        </div>
                ...
                <div class="col-lg-3">
                    ...
                    <aside class="widget widget-product box-shadow">
                        ...
                        <div class="product-item">
                            <div class="product-img">
                                <a href="single-product.html">
                                    <img src="{{ asset('store-assets/img/product/4.jpg') }}" alt=""/>
                                </a>
                            </div>
                            <div class="product-info">
                                <h6 class="product-title">
                        ...
                        <div class="product-item">
                            <div class="product-img">
                                <a href="single-product.html">
                                    <img src="{{ asset('store-assets/img/product/8.jpg') }}" alt=""/>
                                </a>
                            </div>
                            <div class="product-info">
                                <h6 class="product-title">
                        ...
                        <div class="product-item">
                            <div class="product-img">
                                <a href="single-product.html">
                                    <img src="{{ asset('store-assets/img/product/12.jpg') }}" alt=""/>
                                </a>
                            </div>
                            <div class="product-info">
                                <h6 class="product-title">
