                    ...
                    <div class="my-account-content" id="accordion">
                        ...
                        <div class="card mb-15">
                            <div  class="card-header" id="headingOne">
                                <h4 class="card-title">
                                    <a data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">My Personal
                                        Information</a>
                                </h4>
                            </div>
                        ...
                        <div class="card mb-15">
                            <div class="card-header" id="headingTwo">
                                <h4 class="card-title">
                                    <a data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">My shipping
                                        address</a>
                                </h4>
                            </div>
                        ...
                        <div class="card mb-15">
                            <div class="card-header">
                                <h4 class="card-title">
                                    <a data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">My billing
                                        details</a>
                                </h4>
                            </div>
                        ...
                        <div class="card mb-15">
                            <div class="card-header">
                                <h4 class="card-title">
                                    <a data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">My Order
                                        info</a>
                                </h4>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">
                                    <a data-bs-toggle="collapse" data-bs-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive">Payment
                                        Method</a>
                                </h4>
                            </div>
